                    ...
                    <div class="row no-gutters">
                        <div class="col-xl-12">
                            <div class="auth-form bg-white rounded shadow p-lg-5 p-3">
                               ...
                               <form class="my-2" method="POST" action="{{ route('user.password.email') }}">
                                @csrf
                                ...
                                <div class="form-group mb-0 row">
                                    <div class="col-12">
                                        <div class="d-grid mt-3">
                                            <button class="btn btn-primary btn-lg" type="submit">Submit <i class="fas fa-sign-in-alt ms-1"></i></button>
                                        </div>
                                    </div><!--end col--> 
                                </div> <!--end form-group-->                           
                            </form>
