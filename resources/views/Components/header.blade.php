<style >
	...
	.header{
		...
		height: auto;
        border-bottom: none;
            background: linear-gradient(0deg, rgb(0 99 149) 00%, rgb(0 0 0 / 100%) 270%);
    }
...
.header .chatbox .nav-tabs .nav-link.active{
    background: unset;
    border-radius: unset;
}
.header-right{
               ...
               <div class="row py-3">
                  <div class="col-10 col-sm-10 col-md-10 col-lg-10">
                     <nav class="navbar navbar-expand-lg rounded ">
                          ...
                          <div class="collapse navbar-collapse showNavBar" id="navbarSupportedContent ">
                              <ul class="navbar-nav ms-auto ">
                                 <li class="nav-item">
                                    ...
                                    <a class="nav-link {{ Route::currentRouteName() == 'player.dashboard2' ? 'active' : ''}} " aria-current="page" href="{{ route('player.dashboard2') }}"><i class="flaticon-home"></i> Dashboard </a>
                                    @else
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle {{ in_array(Route::currentRouteName(), ['team.schedule.show.calander', 'team.allTeamDashboard', 'team.team_administrator']) ? 'active show' : '' }}" href="#" id="navbarDropdownMenuLink" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
                               ...
                               <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="{{ request()->is('players*') ? 'mm-active' : '' }}" id="navbarDropdownMenuLink" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="#"><i class="flaticon-search-interface-symbol"></i> Discover</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="#"><i class="flaticon-blog"></i> Highlights</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="#"><i class="flaticon-bar-chart"></i> Stats</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="#"><i class="flaticon-registration"></i> News</a>
                        </li>
   ...
   <nav class="">
    ...
    <li class="nav-item dropdown notification_dropdown">
                            <a class="nav-link bell-link" href="javascript:void(0);">
                              ...
                              <span id="unread-count" class="badge text-white bg-secondary pulse">5</span>
                          </a>
                      </li>
                      <div class="notification-box widget-media" id="notification-box">
                        <ul class="timeline" id="timeline">
