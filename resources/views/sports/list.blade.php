                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('sports.create') }}" class="btn btn-primary ms-2">Create
                                Sport</a>
                        </div>
                        <div class="card-body">
                                ...
                                <table id="example3" class="display datatable2" style="min-width: 850px">
                                    ...
                                    <tbody>
                                         @forelse ($sports as $sport)
                                            <tr>
                                                <td>{{ $sport->name }}</td>
                                                <td>{{ $sport->status == 1 ? 'Active' : 'Inactive' }}</td>
                                                 <td>
                                                    <div class="dropdown ms-auto c-pointer">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <a class="dropdown-item" href="javascript:void(0);"
                                                                ...
                                                                data-team-id="{{ $sport->id }}"
                                                                data-team-name="{{ $sport->name }}">Delete</a>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="4" class="text-center">No sports available.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                $('#deleteModalCenter').on('show.bs.modal', function(event) {
                    ...
                    modal.find('#delete-form').attr('action', '{{ route('sports.destroy', ':id') }}'.replace(
                        ':id', btoa(teamId)));
                });
