...
<div class="content-body">
               ...
               <form  action="{{ route('schedule.update', base64_encode($schedule->id)) }}" method="POST">
                                ...
                                <div class="mb-3 col-md-6 tournament-fields game-fields" style="display: {{ in_array($schedule->type, ['Game', 'Tournaments']) ? 'block' : 'none' }};">
                                    ...
                                    <input class="dateInput form-control @error('date') is-invalid @enderror" type="text" id="dateInput" placeholder="mm/dd/yyyy" name="date" value="{{ $schedule->date }}">
                                    @error('date')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                               ...
                               <!--  <div class="mb-3 col-md-6 practice-fields game-fields" style="display: {{ $schedule->type == 'Practice' ? 'block' : 'none' }};">
                                ...
                                <div class="mb-3 col-md-6 practice-fields" style="display: {{ $schedule->type == 'Practice' ? 'block' : 'none' }};">
                                    ...
                                    <input class="dateInput form-control @error('date_from') is-invalid @enderror" type="text" id="dateInput" placeholder="mm/dd/yyyy" name="date_from" value="{{ $schedule->date_from }}">
                                    @error('date_from')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="mb-3 col-md-6 practice-fields" style="display: {{ $schedule->type == 'Practice' ? 'block' : 'none' }};">
                                    ...
                                    <input class="dateInput form-control @error('date_to') is-invalid @enderror" type="text" id="dateInput" placeholder="mm/dd/yyyy" name="date_to" value="{{ $schedule->date_to }}">
                                    @error('date_to')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
