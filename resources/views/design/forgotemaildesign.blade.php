...
<body>
    ...
    <div class="email-container" style="">
        ...
        <div class=" btn-wrapper">
            <a href="[Reset Password Link]" class="btn btn-primary btn-lg">
                Reset Password
            </a>
        </div>
        ...
        <div class="text-center mt-4" style="font-size: 14px; color: #666;">
            <p>If you have any questions, please contact our support team at 
                <a href="mailto:support@yourbrand.com" style="color: #007bff; text-decoration: none;"><br>support@recstep.com</a>.
            </p>
